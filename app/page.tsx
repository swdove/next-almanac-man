    ...
    return (
        <div className="container">
          ...
          <main>
            ...
            <a href="https://theghostisclearrecords.limitedrun.com/products/784450-almanac-man-terrain">
              <p className="description text-slate-500 dark:text-slate-400">PHYSICAL</p>
            </a>
